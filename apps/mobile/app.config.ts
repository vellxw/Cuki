...
const config:ExpoConfig={name:testMode?'CUKI Test':'CUKI',slug:'cuki',version:'0.1.0',scheme:'cuki',orientation:'portrait',userInterfaceStyle:'automatic',
 ...
 plugins:['expo-router','expo-sqlite','expo-secure-store','expo-camera','expo-image-picker','expo-notifications','expo-audio','expo-localization', ['expo-build-properties',{android:{usesCleartextTraffic:testMode},ios:{deploymentTarget:'16.4'}}]],
